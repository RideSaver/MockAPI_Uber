...
namespace UberAPI.Models
{
    ...
    {
        public EstimateWithSurge(EstimateWithSurgeEstimateFareBreakdownInner estimate = default(EstimateWithSurgeEstimateFareBreakdownInner), EstimateWithoutSurgeTrip trip = default(EstimateWithoutSurgeTrip), int pickupEstimate = default(int))
        {
        ...
        public EstimateWithSurgeEstimateFareBreakdownInner Estimate { get; set; }
